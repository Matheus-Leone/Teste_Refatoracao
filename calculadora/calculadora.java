...
public class calculadora {
    ...
    */
    ...
    /*
    *Subtração dois números inteiros
    *
    *
    * @param a primeiro operando
    * @param b segundo operando
    ...
    */
    ...
    /*
    *Multiplicação dois números inteiros
    *
    *
    ...
    * Caso o {@code b} for 0, ele mostrará uma mensagem que "Não é permitido dividir por 0"
    */
    ...
    * @param a
    * @param b 
    * @param símbolo da operação desejada
    * @return o resultado da operação corresponde ao operador informado
    * 
